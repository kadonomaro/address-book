<template>
	<form action="" class="add-contact-form">
		...
		<div class="add-contact-form__group">
			<v-input
				class="add-contact-form__field"
				:title="'Имя'"
				:focus="true"
				:required="true"
				@on-change="updateFormValue($event, 'name')"
			/>
			<v-input
				class="add-contact-form__field"
				:title="'Адрес'"
				@on-change="updateFormValue($event, 'location')"
			/>
		</div>
		...
		<div class="add-contact-form__group">
			<v-input
				...
				:title="'Телефон'"
				:type="'tel'"
				@on-change="updateFormValue($event, 'phone')"
			/>
			<v-input
				class="add-contact-form__field"
				:title="'E-mail'"
				:type="'email'"
				@on-change="updateFormValue($event, 'email')"
			/>
		</div>
		...
		<div class="add-contact-form__group">
			<v-input
				class="add-contact-form__field"
				:title="'Возраст'"
				@on-change="updateFormValue($event, 'age')"
			/>
			<v-input
				class="add-contact-form__field"
				:title="'Статус'"
				@on-change="updateFormValue($event, 'tags')"
			/>
		</div>
